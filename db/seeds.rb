...
type = WorkoutType.last
if (!type)
  WorkoutType.create([{ title: 'Squat', sort_order:0, weight_increase:10 },
                      { title: 'Bench Press', sort_order:1, weight_increase:5 },
                      { title: 'Deadlift', sort_order:2, weight_increase:10 },
                      { title: 'Overhead Press', sort_order:3, weight_increase:5 }])
